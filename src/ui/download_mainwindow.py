...
"")
        ...
        self.video_format_id_combobox.addItem("")
        self.video_format_id_combobox.addItem("")
        self.video_format_id_combobox.setObjectName(u"video_format_id_combobox")
        self.video_format_id_combobox.setGeometry(QRect(190, 390, 161, 23))
        self.label_7 = QLabel(self.centralwidget)
        self.label_7.setObjectName(u"label_7")
        self.label_7.setGeometry(QRect(380, 390, 41, 21))
        self.audio_format_id_combobox = QComboBox(self.centralwidget)
        self.audio_format_id_combobox.addItem("")
        self.audio_format_id_combobox.addItem("")
        self.audio_format_id_combobox.setObjectName(u"audio_format_id_combobox")
        self.audio_format_id_combobox.setGeometry(QRect(430, 390, 161, 23))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.video_format_id_combobox.setItemText(0, QCoreApplication.translate("MainWindow", u"bestvideo", None))
        self.video_format_id_combobox.setItemText(1, QCoreApplication.translate("MainWindow", u"None", None))

        self.label_7.setText(QCoreApplication.translate("MainWindow", u"\u97f3\u9891\uff1a", None))
        self.audio_format_id_combobox.setItemText(0, QCoreApplication.translate("MainWindow", u"bestaudio", None))
        self.audio_format_id_combobox.setItemText(1, QCoreApplication.translate("MainWindow", u"None", None))
