...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.video_download_button.setGeometry(QRect(60, 380, 231, 23))
        ...
        self.cmd_output_plaintextedit.setGeometry(QRect(60, 420, 831, 261))
        self.video_url_lineedit = QLineEdit(self.centralwidget)
        self.video_url_lineedit.setObjectName(u"video_url_lineedit")
        self.video_url_lineedit.setGeometry(QRect(120, 310, 771, 21))
        self.label_3 = QLabel(self.centralwidget)
        self.label_3.setObjectName(u"label_3")
        self.label_3.setGeometry(QRect(60, 310, 61, 21))
        ...
        self.label_5.setGeometry(QRect(60, 340, 81, 21))
        self.video_format_lineedit = QLineEdit(self.centralwidget)
        self.video_format_lineedit.setObjectName(u"video_format_lineedit")
        self.video_format_lineedit.setGeometry(QRect(130, 340, 311, 21))
        self.label_6 = QLabel(self.centralwidget)
        self.label_6.setObjectName(u"label_6")
        self.label_6.setGeometry(QRect(450, 340, 251, 21))
